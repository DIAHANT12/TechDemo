        ...
        <section className={clientLayout.section}>
            <div className={clientLayout.sectionInfo}>
                ...
                <p className={`${styles.paragraph}  mt-5`}>
                    By assembling a team of dedicated offshore developers, GoWithTech has successfully aided global enterprises in their growth by providing top-quality software solutions.
                </p>
            </div>
