    ...
    const handleOnSubmit = async (e) => {
        ...
        try {
            ...
            const response = await fetch(
                "https://commencement.technology/api/v1/contact_us",
                {
                    method: "POST",
                    headers: {
                ...
                <div className="font-thin flex flex-col w-[100%] ">
                    <form onSubmit={handleOnSubmit}>
                        ...
                        <div className=" text-center">
                            ...
                            <a className=" text-green-400 hover:border-b-2 hover:border-green-400 " href="mailto:info@peerbits.com">info@peerbits.com</a>
                        </div>
                    </form>
                </div>
            </div>
